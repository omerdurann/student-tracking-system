    ...
    $(document).ready(function(){
        var chart = c3.generate({
            ...
            data: {
                ...
                colors: {
                    'data1': anchor.colors["gray"],
                    'data2': anchor.colors["indigo"],
                    'data3': anchor.colors["pink"]
                },
                names: {
                    // name of each serie
                    'data1': 'Development',
    ...
    $(document).ready(function(){
        var chart = c3.generate({
            ...
            data: {
                ...
                colors: {
                    'data1': anchor.colors["indigo-darker"],
                    'data2': anchor.colors["indigo"],
                    'data3': anchor.colors["indigo-light"],
                    'data4': anchor.colors["indigo-lighter"]
                },
                names: {
                    // name of each serie
                    'data1': 'A',
